...
${FULL_PATH_DIR_AUXILIARY_SCRIPTS}/yri_sd_runtime_verif_lang_comp < ${INPUT_SD_MEALY_FILE}
...
yerithx-rename-files.sh -o "${GENERATED_FILE_PREFIX}" \
...
yerithx-replace-string.sh -o "${GENERATED_FILE_PREFIX}" \
